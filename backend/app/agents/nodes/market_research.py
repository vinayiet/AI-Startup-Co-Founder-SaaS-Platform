...
async def market_research_node(state: AgentState) -> AgentState:
    ...
    system_prompt = (
        ...
        "   CRITICAL: Use the most current data available (2025/2026 onwards). Do NOT reference outdated statistics from 2022 or earlier.\n"
        ...
        "   CRITICAL: Do NOT default to assuming SOM is exactly 1% of SAM. Calculate SOM dynamically based on anticipated sales cycle length, customer acquisition difficulty, and realistic Year 1 team capacity.\n"
        ...
        "   CRITICAL: Format all large monetary values into human-readable units (e.g. '₹7.2 Crore', '₹15,000 Crore', '$1.2 Billion'). Do NOT output raw 12-digit integers.\n"
