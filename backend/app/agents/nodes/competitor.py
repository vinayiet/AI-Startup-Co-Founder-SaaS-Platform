...
async def competitor_node(state: AgentState) -> AgentState:
    ...
    system_prompt = (
        ...
        "3. If pricing information for a competitor is not explicitly present in the search snippets, use your industry expertise to provide a realistic estimated pricing range (e.g. '$15/month basic (estimated)'). DO NOT output 'data not found', as downstream financial models strictly require an ARPU anchor.\n"
