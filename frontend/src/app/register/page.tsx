...
export default function RegisterPage() {
    ...
    return (
        <div className="relative min-h-screen bg-grid-pattern flex items-center justify-center px-4">
            <div className="absolute bottom-1/4 right-1/4 w-[40%] h-[40%] rounded-full bg-pink-900/10 blur-[120px]" />
            ...
            <div className="relative z-10 w-full max-w-md glass-panel p-8 rounded-3xl border border-zinc-800 shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-sm text-zinc-400 text-center">Start validating your startup ideas immediately</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-purple-500/25 disabled:opacity-50"
                    >
